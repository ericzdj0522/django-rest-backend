...
class CNSerializer(GeoFeatureModelSerializer):
...
class CPSerializerCN(GeoFeatureModelSerializer):

    class Meta:
        model = Controlpoints_CN
        geo_field = 'geom'
        fields = ["id", "longitude", "latitude","count","sl1_time","sl2_time","sl3_time"]
...
class CPcellsSerializerCN(GeoFeatureModelSerializer):
